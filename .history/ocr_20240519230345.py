...
auth_key = "32e2f76a-2e5a-4385-bbc6-d6962f4d4816:fx"  # Replace with your key
translator = deepl.Translator(auth_key)

# Translate a formal document from Korean to English
input_path = "./test.pdf"
...
try:
    translator.translate_document_from_filepath(
        input_path,
        output_path,
        source_lang="KO",  # Explicitly set source language to Korean
        target_lang="EN-US",  # Specify English (US) for better accuracy
        formality="more"  # If you want more formal translations 
    )
