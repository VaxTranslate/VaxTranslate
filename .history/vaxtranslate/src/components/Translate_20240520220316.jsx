    ...
    <div className="flex items-center justify-center mt-20">
      <div className="w-1/3">
        <div  
          ...
          <div class="mt-4 file-list" style="width: 600px; margin: 0 auto; max-height: 192px; overflow-y: auto;">
  {selectedFiles.map((file, index) => (
    <div 
      key={index}
      style="display:flex; align-items: center; border: 1px solid #eee; padding: 8px; margin-bottom: 8px; border-radius: 5px;"
    >
      <img 
