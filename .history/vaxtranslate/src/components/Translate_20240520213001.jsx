...
const Translate = () => {
  ...
  return (
    <div className="d-flex align-items-center justify-content-center" style={{marginTop: "50px"}}>
      ...
      >
        <div className="card shadow p-5 d-flex flex-column align-items-center flex-grow-1" style={{ width: "100%", maxWidth: "800px", height: "650px", borderRadius: "10px" }}>
          ...
          <div 
            ...
            style={{ maxHeight: "450px", height: fileListHeight, overflowY: selectedFiles.length > 2 ? "scroll" : "auto" }}
          >
