...
const Navbar = () => {
    return (
        <nav className="navbar navbar-expand-lg navbar-light" style={{ backgroundColor: "white", boxShadow: "0 2px 4px rgba(0, 0, 0, 0.2)", fontFamily: 'Inter, sans-serif', fontWeight: "bold" }}>
            <Link to="/" className="navbar-brand ms-30" style={{color: "#3485FF"}}>
                VAX Translate
            </Link>
            <button
