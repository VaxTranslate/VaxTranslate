...
const Translate = () => {
  ...
  const fileListHeight = selectedFiles.length * 75;


  return (
    <div className="d-flex align-items-center justify-content-center" style={{marginTop: "50px"}}>
      <div
        className="d-flex align-items-center justify-content-center flex-grow-1" // Allow it to grow
        style={{ maxHeight: "650px" }} // Set a reasonable max limit to avoid excessive height
      >
        <div className="card shadow p-5 d-flex flex-column align-items-center" style={{ width: "100%", maxWidth: "800px", height: "650px", borderRadius: "10px" }}>
          ...
          <div 
            ...
            style={{ maxHeight: "450px", height: fileListHeight }}
          >
