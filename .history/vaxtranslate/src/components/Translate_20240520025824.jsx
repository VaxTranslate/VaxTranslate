...
const Translate = () => {
  ...
  const handleFileChange = (event) => {
    ...
    // Do something with the selectedFile (e.g., upload to server)
    ...
    <div className="d-flex align-items-center justify-content-center" style={{marginTop: "50px"}}>
      <div className="d-flex align-items-center justify-content-center"> 
        <div className="card shadow p-5 d-flex flex-column align-items-center" style={{ width: "800px", height: "850px", borderRadius: "10px" }}>
          ...
          <div className="mt-5">
            <button className="btn btn-primary btn-lg rounded-pill" style={{boxShadow: "0 2px 4px rgba(0,0,0,0.2)", padding: "10px 80px 10px 80px"}}>Translate</button>
          </div>
        </div>
      </div>
    </div>
