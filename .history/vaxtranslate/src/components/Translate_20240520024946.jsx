      ...
      <div className="d-flex align-items-center justify-content-center"> 
        <div className="card shadow p-5 d-flex flex-column align-items-center" style={{ width: "800px", height: "850px", borderRadius: "10px" }}>
          ...
          <div className="row mt-4">
            <div className="col">
              <button className="btn btn-outline-primary rounded-pill w-100" style={{ fontSize: "20px" }}>Button 1</button>
            </div>
            <div className="col">
              <button className="btn btn-outline-primary rounded-pill w-100" style={{ fontSize: "20px" }}>Button 2</button>
            </div>
            <div className="col">
              <button className="btn btn-outline-primary rounded-pill w-100" style={{ fontSize: "20px" }}>Button 3</button>
            </div>
            <div className="col">
              <button className="btn btn-outline-primary rounded-pill w-100" style={{ fontSize: "20px" }}>Button 4</button>
            </div>
          </div>

          <div className="mt-5">
            <button className="btn btn-primary rounded-pill w-400" style={{ fontSize: "24px" }}>Translate</button>
          </div>
        </div>
      </div>
    </div>
