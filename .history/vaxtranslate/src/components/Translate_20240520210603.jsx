    ...
    <div className="d-flex align-items-center justify-content-center" style={{marginTop: "50px"}}>
      <div className="d-flex align-items-center justify-content-center"> 
        <div className="card shadow p-5 d-flex flex-column align-items-center" style={{ width: "100%", maxWidth: "800px", height: "650px", borderRadius: "10px" }}>
          ...
          {selectedFile && (
            <div className="d-flex align-items-center mt-4 border rounded p-2" style={{ width: "80%" }}> 
              <img src={URL.createObjectURL(selectedFile)} alt="uploaded" style={{ width: "50px", marginRight: "20px" }} />
              <span className="mr-auto">{selectedFile.name}</span>
              <button onClick={handleFileDelete} className="btn btn-link p-0"> 
          ...
          <div className="mt-5">
            <button className="btn btn-primary btn-lg rounded-pill" style={{boxShadow: "0 2px 4px rgba(0,0,0,0.2)", padding: "10px 80px 10px 80px", marginTop: "50px", marginBottom: "30px"}}>Translate</button>
          </div>
        </div>
      </div>
    </div>
