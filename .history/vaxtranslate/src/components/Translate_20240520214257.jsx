      ...
      <div className="flex items-center justify-center">
        <div className="bg-white shadow-md rounded-md p-5 flex flex-col items-center flex-grow w-full max-w-3xl h-[42rem]">
          ...
          <div className="mt-4 flex justify-between w-full">
            <button className="btn btn-outline-primary rounded-pill w-1/4">Button 1</button>
            <button className="btn btn-outline-primary rounded-pill w-1/4">Button 2</button>
            <button className="btn btn-outline-primary rounded-pill w-1/4">Button 3</button>
