    ...
    <div className="container d-flex align-items-center justify-content-center">
      <div className="d-flex align-items-center justify-content-center"> 
        <div className="card shadow p-5 d-flex flex-column align-items-center" style={{ width: "800px", height: "850px", borderRadius: "10px" }}>
          <div className="file-upload border border-3 border-dashed rounded-3 p-5 text-center" style={{ backgroundColor: "#E2F0FF", borderColor: "#3485FF", cursor: "pointer", borderRadius: "10px", padding: "70px 0 30px 0" }}>
