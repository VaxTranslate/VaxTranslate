      ...
      <div className="flex items-center justify-center">
        <div className="bg-white shadow-md rounded-md p-5 flex flex-col items-center flex-grow w-full max-w-3xl h-[42rem]">
          ...
          <div className="mt-4 grid grid-cols-4 gap-4 w-full">
            <div className="col">
              <button className="btn btn-outline-primary rounded-pill w-full">Button 1</button>
            </div>
            <div className="col">
              <button className="btn btn-outline-primary rounded-pill w-full">Button 2</button>
            </div>
            <div className="col">
              <button className="btn btn-outline-primary rounded-pill w-full">Button 3</button>
            </div>
            <div className="col">
              <button className="btn btn-outline-primary rounded-pill w-full">Button 4</button>
            </div>
          </div>

          <div className="mt-4 w-100 file-list overflow-auto">
